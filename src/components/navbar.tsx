...
import logo from 'https://flowbite.com/docs/images/logo.svg';

const Navbar = () => {
    return (
        <>
            <nav className="bg-white p-3 dark:bg-gray-900 w-full z-20 top-0 start-0 border-b border-gray-200 dark:border-gray-600">
